...
async function seed() {
    try {
        ...
        await Reservation.insertMany([
            { room: "Gokongwei 302", date: today, slotIndex: 2, slotTime: "8:30 AM - 9:00 AM", user: findUserId('oliver.berris@dlsu.edu.ph'), userRole: "teacher", isAnonymous: false },
            { room: "Gokongwei 302", date: today, slotIndex: 3, slotTime: "9:00 AM - 9:30 AM", user: findUserId('oliver.berris@dlsu.edu.ph'), userRole: "teacher", isAnonymous: false },
